---
name: daydream
description: Multi-agent system that mines notes/files for non-obvious connections, mimicking the brain's default mode network. Samples random pairs, synthesizes connections via Sonnet, filters with a Haiku critic. Originally designed for Obsidian vaults but works on any directory of markdown files.
---
