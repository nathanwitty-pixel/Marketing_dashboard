...
<head>
  ...
  <style>
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    /* ── Consistency with the other pages: reduced-motion, glass cards, aura ── */
    ...
    .kpi{{ background-color:rgba(24,27,40,0.52) !important; background-image:none !important;
      backdrop-filter:blur(14px) saturate(1.08); -webkit-backdrop-filter:blur(14px) saturate(1.08); }}
    @media (prefers-reduced-transparency: reduce){{
      .kpi{{ background-color:#141824 !important; backdrop-filter:none; -webkit-backdrop-filter:none; }} }}
